...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of CollapsibleTreeView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Mikayel Aghasyan/CollapsibleTreeView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Mikayel Aghasyan' => 'mikayel.aghasyan@gmail.com' }
  s.source           = { :git => 'https://github.com/Mikayel Aghasyan/CollapsibleTreeView.git', :tag => s.version.to_s }
